          ...
          <div className="relative z-10 bg-[#111113] rounded-2xl border border-white/10 p-6 shadow-2xl overflow-hidden group hover:border-indigo-500/30 transition-colors duration-500">
            ...
            <div className="space-y-2 font-mono text-sm">
              <div className="flex">
                ...
                <span className="text-indigo-400">class</span> <span className="text-yellow-200 ml-2">StarFlux</span> <span className="text-yellow-200 ml-2">Innovation</span> <span className="text-white">{` {`}</span>
              </div>
              <div className="flex">
